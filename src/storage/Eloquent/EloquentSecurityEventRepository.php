...
/**
 * Eloquent implementation of SecurityEventRepositoryInterface.
 * Requires a SecurityEvent model that extends Illuminate\Database\Eloquent\Model.
 */
class EloquentSecurityEventRepository implements SecurityEventRepositoryInterface
{
    ...
    private function modelToEntity(Model $model): SecurityEvent
    {
        return SecurityEvent::fromArray($model->toArray());
    }
}
